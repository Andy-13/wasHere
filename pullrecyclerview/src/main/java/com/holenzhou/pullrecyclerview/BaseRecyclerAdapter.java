...
import com.holenzhou.pullrecyclerview.layoutmanager.DownloadImageTask;
...
//        Timber.d("isShowLoadDoneTip: " + isShow);
    ...
    public void setHeaderTextView(int textId, String text) {
        TextView textView = (TextView) mHeaderView.findViewById(textId);
        textView.setText(text);
        this.notifyDataSetChanged();
    }


    public void setHeaderImageView(int id, String url) {
        ImageView imageView = (ImageView) mHeaderView.findViewById(id);
